...
public class DocAdapter extends BaseAdapter implements OnClickListener {

    private Activity activity;
    private ArrayList<Doctor> data;
    private static LayoutInflater inflater=null;
    public Resources res;
    Doctor tempValues=null;

    public DocAdapter(Activity activity, ArrayList<Doctor> data, Resources res) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            vi = inflater.inflate(R.layout.doctor_adapter, null);
            ...
            viewHolder.tvSpecialite = (TextView) vi.findViewById(R.id.spec);
        ...
        {
            tempValues=null;
            tempValues = ( Doctor ) data.get( position );

            /************  Set Model values in Holder elements ***********/

            viewHolder.tvNom.setText( tempValues.getNom()+ "  " + tempValues.getPrenom() );
            viewHolder.tvSpecialite.setText( tempValues.getSpecialite() );
            ...
            viewHolder.ivPhoto.setBackground(ContextCompat.getDrawable(activity,R.drawable.doctor));
